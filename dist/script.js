...
function clickApp(state, action) {
    if (state === void 0) { state = initialState; }
    switch (action.type) {
        case ADD_WORD:
            return Object.assign({}, state, {
                words: __spreadArrays(state.words, [action.word]),
            });
        case RECEIVE_WORDS:
...
var store = createStore(clickApp, applyMiddleware(redux_thunk_es // lets us dispatch() functions
));
...
var NotchedOutline = /*#__PURE__*/react.forwardRef(function NotchedOutline(props, ref) {
  ...
  return /*#__PURE__*/react.createElement("fieldset", extends_extends({
    "aria-hidden": true,
    style: extends_extends(defineProperty_defineProperty({}, "padding".concat(capitalize(align)), 8), style),
    className: clsx_m(classes.root, className),
    ref: ref
  }, other), /*#__PURE__*/react.createElement("legend", {
...
var Menu = /*#__PURE__*/react.forwardRef(function Menu(props, ref) {
  var _props$autoFocus = props.autoFocus,
      ...
      _props$variant = props.variant,
      variant = _props$variant === void 0 ? 'selectedMenu' : _props$variant,
      other = objectWithoutProperties_objectWithoutProperties(props, ["autoFocus", "children", "classes", "disableAutoFocusItem", "MenuListProps", "onClose", "onEntering", "open", "PaperProps", "PopoverClasses", "transitionDuration", "variant"]);
...
/* harmony default export */ const ArrowDropDown = (createSvgIcon( /*#__PURE__*/react.createElement("path", {
  d: "M7 10l5 5 5-5z"
}), 'ArrowDropDown'));
...
;// CONCATENATED MODULE: ./src/apicalls.tsx
...
(function (Word) {
    Word[Word["red"] = 0] = "red";
    Word[Word["blue"] = 1] = "blue";
    Word[Word["neutral"] = 2] = "neutral";
})(Word || (Word = {}));
var Turn;
(function (Turn) {
    Turn[Turn["blue-spymaster"] = 0] = "blue-spymaster";
    Turn[Turn["red-spymaster"] = 1] = "red-spymaster";
    Turn[Turn["blue-chooser"] = 2] = "blue-chooser";
    Turn[Turn["red-chooser"] = 3] = "red-chooser";
})(Turn || (Turn = {}));
...
function spymaster_Move(game_ID, hint, attempts) {
    return __awaiter(this, void 0, void 0, function () {
...
function addWord(word) {
    return { type: ADD_WORD, word: word };
}
...
function refreshState(game_ID, get_State) {
    console.log(game_ID);
...
;// CONCATENATED MODULE: ./src/containers/StateBox.js
...
function StateBox(props) {
    ...
    var mapDispatchToProps = function (dispatch) { return ({
        spymasterMove: function (game_ID, hint, attempts) {
            return dispatch(makeSpymasterMove(game_ID, hint, attempts));
        },
    }); };
    StateBox = connect(mapStateToProps, mapDispatchToProps)(StateBox);
    return react.createElement(StateBox, __assign({}, props));
}
...
function Board(props) {
    ...
    var _loop_1 = function (word) {
        cells.push(react.createElement(src_Cell, { key: word, word: word, state: props.words[word], onClick: function (event) {
                handleClick(word);
            } }));
    };
...
;// CONCATENATED MODULE: ./src/containers/FullBoard.tsx




var FullBoard_mapStateToProps = function (state, ownProps) {
    return {
        game_ID: ownProps.game_ID,
        words: state.words,
    };
};
var FullBoard_mapDispatchToProps = function (dispatch) { return ({
    addWord: function (word) { return dispatch(addWord(word)); },
    refreshState: function (game_ID) { return dispatch(refreshState(game_ID, get_State)); },
    clickWord: function (word) { return dispatch(clickWord(word)); },
}); };
/* harmony default export */ const FullBoard = (connect(FullBoard_mapStateToProps, FullBoard_mapDispatchToProps)(Board));
...
var react_router_node_modules_react_is = __webpack_require__(663);
...
function Game() {
    ...
    return (react.createElement("div", { className: "main" },
        ...
        react.createElement(FullBoard, { game_ID: game_ID })));
}
