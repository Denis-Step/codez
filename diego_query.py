...
def update_user(id_update, name_update, email_update, password_update, gamesPlayed_update, gamesWon_update):
...
def update_game_history(game_history_id_update, history_update, winners_update, date_update):
